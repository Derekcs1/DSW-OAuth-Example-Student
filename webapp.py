...
#context processors run before template are rendered and add variab les to the template context 
# must return a dictionary
# adds logged_in for all templates
...
# Token getter is automatically called to check who is logged in.
@github.tokengetter
